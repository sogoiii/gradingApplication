...
passport.deserializeUser(function(id, done) {
  ...
  TeacherUserSchema.findById(id, function (err, user) {
    done(err, user);
  });
});
...
passport.use(new LocalStrategy(
  function(username, password, done) {
    ...
    process.nextTick(function () {
      ...
      TeacherUserSchema.findOne({user: username}, function( err, user){
...
app.post('/login', 
  passport.authenticate('local', { successRedirect: '/userlist', failureRedirect: '/login' }),
  routes.postlogin
  //res.redirect('/');
);
